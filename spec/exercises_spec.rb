...
describe "all_unique_chars?" do
  it "returns false on repeats" do
    expect(all_unique_chars?("abbaac")).to eq(false)
  end
  it "returns true on uniqs" do
    expect(all_unique_chars?("butes")).to eq(true)
  end
  it "ignores spaces and returns true on uniqs" do
    expect(all_unique_chars?("due stil no rp")).to eq(true)
  end
  it "ignores spaces and returns false on repeats" do
    expect(all_unique_chars?("dude stil no rp")).to eq(false)
  end
end
